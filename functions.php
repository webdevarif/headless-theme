...
function headless_theme_setup() {
	/*
		...
		* If you're building a theme based on Headless Theme, use a find and replace
		* to change 'headless-theme' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'headless-theme' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'headless_theme_custom_background_args',
			array(
